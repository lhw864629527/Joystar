package com.erbao.videoimg.camera;
...
public class CameraController implements ICamera {
    ...
    public void onFocus(Point point, Camera.AutoFocusCallback callback) {
        ...
        //再次进行转换
        point.x= (int) (((float)point.x)/ VideoimgInitialize.screenWidth*2000-1000);

        point.y= (int) (((float)point.y)/ VideoimgInitialize.screenHeight*2000-1000);
