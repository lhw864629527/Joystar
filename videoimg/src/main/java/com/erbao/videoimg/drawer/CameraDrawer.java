...
import com.erbao.videoimg.filter.CameraFilter;
...
import com.erbao.videoimg.record.video.TextureMovieEncoder;
...
//        waterMarkFilter.setPosition(30,50,0,0);
        waterMarkFilter.setPosition(0,70,120,50);
...
//        mSlideFilterGroup.onSizeChanged(mPreviewWidth,mPreviewHeight);
        mChangedtoFilter.onSizeChanged(mPreviewWidth,mPreviewHeight);
...
//        mAfFilter.setTextureId(mSlideFilterGroup.getOutputTexture());
        mAfFilter.setTextureId(mChangedtoFilter.getOutputTexture());
        mAfFilter.draw();
