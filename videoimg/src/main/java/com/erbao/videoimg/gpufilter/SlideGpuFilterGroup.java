package com.erbao.videoimg.gpufilter;
...
public class SlideGpuFilterGroup {
    ...
    public SlideGpuFilterGroup() {
        initFilter();
        scroller = new Scroller(VideoimgInitialize.getContext());
    }
    ...
    public void onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                locked = true;
                downX = -1;
                if (offset > VideoimgInitialize.screenWidth / 3) {
                    scroller.startScroll(offset, 0, VideoimgInitialize.screenWidth - offset, 0, 100 * (1 - offset / VideoimgInitialize.screenWidth));
                    needSwitch = true;
                } else {
                    scroller.startScroll(offset, 0, -offset, 0, 100 * (offset / VideoimgInitialize.screenWidth));
                    needSwitch = false;
                }
                break;
        }
