...
package com.erbao.videoimg.record.video;
...
import com.erbao.videoimg.gpufilter.basefilter.MagicCameraInputFilter;
import com.erbao.videoimg.record.gles.EglCore;
...
//    private MagicFilterType type = MagicFilterType.NONE;
    private AFilter mShowFilter=new NoFilter(VideoimgInitialize.getContext().getResources());
