...
public class VideoClipper {
    ...
    public void setInputVideoPath(String inputPath) {
        ...
        Log.e("tag","=====mInputVideoPath========"+mInputVideoPath);
        initVideoInfo();
    }

    public void setOutputVideoPath(String outputPath) {
        mOutputVideoPath = outputPath;
        Log.e("tag","=====mOutputVideoPath========"+mOutputVideoPath);
    }
...
//                muxAudioTrack = mMediaMuxer.addTrack(format);
     ...
     * @throws IOException
     */
    public void clipVideoMuis(long startPosition, long clipDur, String audioin, float videoVolume, float audioVolume, OnEditorListener onEditorListener) throws IOException {
...
//
//Log.e("tag","============"+audioin);
//        mAudioExtractor.setDataSource(audioin);
//
